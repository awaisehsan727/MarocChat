...
{
    public static final String SERVER_UPDATE         = "com.techsole8.marocchat.server.status";
    public static final String SERVER_RECONNECT      = "com.techsole8.marocchat.server.reconnect.";

    public static final String CONVERSATION_MESSAGE    = "com.techsole8.marocchat.conversation.message";
    public static final String CONVERSATION_NEW        = "com.techsole8.marocchat.conversation.new";
    public static final String CONVERSATION_REMOVE    = "com.techsole8.marocchat.conversation.remove";
    public static final String CONVERSATION_TOPIC    = "com.techsole8.marocchat.conversation.topic";
