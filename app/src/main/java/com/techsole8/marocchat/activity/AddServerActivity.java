...
import com.techsole8.marocchat.exception.ValidationException;
...
public class AddServerActivity extends AppCompatActivity implements OnClickListener
{
    ...
    private void addServer()
    {
        ...
        identity.setNickname("wasi");
        identity.setIdent("");
        identity.setRealName("TechSole");
...
//            );
        ...
        long identityId = db.addIdentity("wasi","MarocChat","Techsole",aliases);
